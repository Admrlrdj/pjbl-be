<div>
    <div class="tab">
        <ul class="nav nav-tabs customtab" role="tablist">
            <li class="nav-item">
                <a wire:click="selectTab('general_settings')"
                    ...
                    href="#general_settings" role="tab" aria-selected="true">General
                    Settings</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content">
                ...
                <div class="pd-20">
                    <form wire:submit='updateSiteInfo()'>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" wire:model="site_meta_keywords"
                                        placeholder="Eg: ecommerce, umkm, etc.">
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="4" rows="4" class="form-control" placeholder="Type site meta description..."></textarea>
            ...
            <div class="tab-pane {{ $tab == 'logo_favicon' ? 'active show' : '' }}" id="logo_favicon" role="tabpanel">
                <div class="pd-20">
                    <div class="row">
                        <div class="col-md-6">
                            <h6>Site Logo</h6>
