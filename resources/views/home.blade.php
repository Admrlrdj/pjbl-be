        ...
        <div class="flex md:flex-row flex-col gap-8 lg:gap-16 items-center">
            ...
            <div class="w-full md:w-1/2 flex flex-col justify-center text-left">
                ...
                <p class="text-gray-600 lg:text-lg md:text-md leading-relaxed mb-8">
                    Jangan Ragu, dijamin ketagihan! temukan cemilan, makanan, dan minuman dengan rasa yang autentik yang
                    selalu bikin harimu bersemangat!
                </p>
                    ...
                    @foreach ($stats as $stat)
                        ...
                        @if ($stat['modal_target'])
                            <button onclick="toggleModal('{{ $stat['modal_target'] }}')"
                                ...
                                <h3
                                    class="text-3xl md:text-4xl text-[#FFD700] font-bold group-hover:scale-110 transition-transform">
                                    {{ $stat['value'] }}
                                </h3>
                                <p class="text-sm md:text-base font-semibold text-gray-700 mt-1">
                                    {{ $stat['label'] }} <span class="text-xs text-zinc-800 underline block">Lihat
                                        Sertifikat</span>
                                </p>
                            </button>
                        ...
                        @else
                            <div
                                class="w-full border-[3px] border-[#FFD700] rounded-2xl flex flex-col items-center justify-center py-4 px-2 shadow-sm bg-white">
                ...
                <!--Modal halal--->
                <div id="halal-modal" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-labelledby="modal-title"
                    role="dialog" aria-modal="true">

                    <div class="fixed inset-0 bg-gray-900 bg-opacity-75 transition-opacity backdrop-blur-sm"
                        onclick="toggleModal('halal-modal')"></div>

                    <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">

                        <div
                            class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg border-t-8 border-[#FFD700]">
                            ...
                            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="h-1 w-20 bg-[#FFD700] rounded mb-4"></div>
                                    <p class="text-sm text-gray-500 mb-6">
                                        Nounoufood berkomitmen menjaga kehalalan produk. Berikut adalah dokumen resmi
                                        sertifikasi kami yang dapat Anda unduh atau lihat:
                                    </p>
                                    ...
                                    <div class="flex flex-col gap-3">
                                        @php
                                            ...
                                            $documents = [
                                                [
                                                    'label' => 'Sertifikat Halal Keripik',
                                                    'filename' => 'halaldanggedang.pdf',
                                                ],
                                                [
                                                    'label' => 'Sertifikat Halal Minuman',
                                                    'filename' => 'halalminuman.pdf',
                                                ],
                                                [
                                                    'label' => 'Sertifikat Halal Basreng',
                                                    'filename' => 'halalkeripik.pdf',
                                                ],
                                            ];
                                        @endphp
                                        ...
                                        @foreach ($documents as $doc)
                                            ...
                                            <a href="{{ asset('sertifikat_halal/' . $doc['filename']) }}" target="_blank"
                                                ...
                                                <div class="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <span
                                                            class="text-sm font-bold text-gray-800 group-hover:text-black block">{{ $doc['label'] }}</span>
                                                        <!-- <span class="text-xs text-gray-400 font-mono">{{ $doc['filename'] }}</span> -->
                                                    </div>
                                                </div>

                                                <svg class="w-5 h-5 text-gray-300 group-hover:text-[#FFD700] transform group-hover:translate-x-1 transition-transform"
                            ...
                            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 border-t border-gray-100">
                                <button type="button"
                                    class="mt-3 inline-flex w-full justify-center rounded-lg bg-white px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-100 sm:mt-0 sm:w-auto transition-colors"
                                    onclick="toggleModal('halal-modal')">
                                    Tutup
                                </button>
                            </div>
                        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                @foreach ($features as $feature)
                    <div
                        class="bg-white border-2 border-gray-200 rounded-xl p-6 text-center hover-scale hover:shadow-lg transition">
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-4 relative">
            ...
            <div class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-full px-4">
                <div
                    class="flex w-full max-w-[611px] h-[90px] sm:h-[70px] md:h-[78px] mx-auto
            ...
            <div
                class="bg-[#FFE34F] rounded-tl-[40px] md:rounded-tl-[80px] 
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 justify-items-center">
                    ...
                    @foreach ($bestSellers as $product)
                        <div
                            class="flex flex-col justify-start items-start gap-3 sm:gap-4 
                            ...
                            <div class="w-full flex flex-col justify-start items-start gap-2 sm:gap-3.5">
                                <div
                                    class="w-full text-zinc-800 text-xl sm:text-2xl font-semibold font-['Poppins'] truncate">
                                    {{ $product['name'] }}
                                </div>

                                <div
                                    class="w-full text-zinc-800 text-sm sm:text-base font-normal font-['Poppins'] 
                                    leading-tight tracking-tight line-clamp-2 min-h-[36px] sm:min-h-[40px]">
                                    {{ $product['description'] }}
                                </div>

                                <div
                                    class="w-full text-orange-400 text-xl sm:text-2xl font-semibold font-['Poppins'] leading-8 sm:leading-10">
                                    {{ $product['price'] }}
                                </div>
                            </div>
    ...
    <section class="py-10 bg-white" id="products">
        ...
        <div class="container mx-auto px-4 md:px-8 max-w-[1240px]">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-between gap-4 mb-6 sm:mb-8 w-full">
                ...
                <div
                    class="flex gap-2 sm:gap-3 flex-nowrap overflow-x-auto pb-2 w-full lg:w-auto items-center scrollbar-hide">
                ...
                <form action="{{ route('products.all') }}" method="GET" class="w-full lg:w-[300px] flex-shrink-0">
                    <div
                        class="relative flex items-center w-full h-10 sm:h-12
                        ...
                        <button type="submit"
                            class="absolute right-3 sm:right-4 w-5 sm:w-6 h-5 sm:h-6 
        ...
        <div class="container mx-auto px-4 md:px-8 max-w-[1240px]">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 justify-items-center mb-6 sm:mb-8">
                ...
                @foreach ($products->take(6) as $product)
                    <div
                        class="w-full max-w-[540px] bg-white border-[3px] sm:border-[4px] border-[#FFD700]
                        ...
                        <div class="flex flex-col justify-between mt-3 sm:mt-0 sm:ml-3 md:ml-4 flex-grow">
                            ...
                            <!-- Title -->
                            <h3
                                class="text-[#2C2C2C] font-[Poppins] font-semibold 
                            ...
                            <!-- Price -->
                            <span
                                class="text-[#FB9E3A] font-[Poppins] text-lg sm:text-[18px] md:text-[20px] 
            ...
            @if ($totalTestimonials === 0)
                ...
                @elseif($totalTestimonials === 1)
                    ...
                    <div class="flex justify-center">
                        <div
                            class="inline-flex flex-col justify-start items-center gap-3.5 w-96 bg-[#FB9E3A] rounded-[20px] border-2 border-gray-200 p-6 text-white">
                            <div class="self-stretch flex flex-col justify-start items-center gap-3.5">
                                <div class="self-stretch flex flex-col justify-start items-center gap-2.5">
                                    ...
                                    <!-- Comment Text -->
                                    <div
                                        class="self-stretch h-32 text-center text-white text-lg font-normal font-['Poppins'] leading-8">
                            ...
                            <div class="w-28 flex flex-col justify-start items-center gap-3.5">
                                ...
                                <div class="self-stretch flex flex-col justify-start items-center">
                                    <div
                                        class="w-36 text-center text-white text-2xl font-semibold font-['Poppins'] leading-8">
                                        {{ $testimonials[0]->name }}
                                    </div>
                                </div>
                            </div>
                ...
                @elseif($totalTestimonials === 2)
                    ...
                    <div class="flex flex-wrap justify-center items-start gap-10">
                        @foreach ($testimonials as $t)
                            <div
                                class="inline-flex flex-col justify-start items-center gap-3.5 w-96 bg-white rounded-[10px] border-2 border-gray-200 p-6">
                                <div class="self-stretch flex flex-col justify-start items-center gap-3.5">
                                    <div class="self-stretch flex flex-col justify-start items-center gap-2.5">
                                        <!-- Quote Icon -->
                                        <div class="size-12 relative overflow-hidden">
                                        ...
                                        <!-- Comment Text -->
                                        <div
                                            class="self-stretch h-32 text-center text-zinc-800 text-lg font-normal font-['Poppins'] leading-8">
                                            {{ $t->comment }}
                                        </div>
                                    </div>
                                ...
                                <div class="w-28 flex flex-col justify-start items-center gap-3.5">
                                    ...
                                    <div class="self-stretch flex flex-col justify-start items-center">
                                        <div
                                            class="w-36 text-center text-zinc-800 text-2xl font-semibold font-['Poppins'] leading-8">
                                            {{ $t->name }}
                                        </div>
                                    </div>
                                </div>
                ...
                @elseif($totalTestimonials === 3)
                    <div class="flex flex-nowrap justify-center items-start gap-6 w-full">
                        @foreach ($testimonials as $index => $t)
                            ...
                            <div
                                class="flex flex-col flex-shrink-0 w-1/3 max-w-[28rem] justify-start items-center gap-3.5 transition-all duration-300 cursor-pointer testimonial-card
    {{ $isCenter
...
"data-index="{{ $index }}">
                                <div class="self-stretch flex flex-col justify-start items-center gap-3.5">
                                    <div class="self-stretch flex flex-col justify-start items-center gap-2.5">
                                        ...
                                        <!-- Comment Text -->
                                        <div
                                            class="self-stretch h-32 text-center {{ $isCenter ? 'text-white' : 'text-zinc-800' }} text-lg font-normal font-['Poppins'] leading-8">
                                            {{ $t->comment }}
                                        </div>
                                    </div>
                                ...
                                <div class="w-28 flex flex-col justify-start items-center gap-3.5">
                                    ...
                                    <div class="self-stretch flex flex-col justify-start items-center">
                                        <div
                                            class="w-36 text-center {{ $isCenter ? 'text-white' : 'text-zinc-800' }} text-2xl font-semibold font-['Poppins'] leading-8">
                                            {{ $t->name }}
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start place-items-center">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="https://s.shopee.co.id/3qFY5AvD2O" target="_blank"
                                        class="text-yellow-300 hover:underline">
                    ...
                    ">
                            ...
                            <iframe src="{{ $contact['maps_embed'] }}" width="100%" height="100%" class="rounded-lg"
