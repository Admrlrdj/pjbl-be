    ...
    <section class="py-10 bg-white">
        ...
        <div class="container mx-auto px-4 md:px-8 max-w-[1240px]">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-4 mb-8 w-full">
                ...
                <div
                    class="flex gap-3 flex-nowrap overflow-x-auto pb-2 w-full md:w-auto items-center scrollbar-hide mask-image-linear-gradient">
                ...
                <form action="{{ route('products.all') }}" method="GET" class="w-full md:w-[300px] flex-shrink-0">
                    <div
                        class="relative flex items-center w-full h-12
                        ...
                        <button type="submit"
                            class="absolute right-4 w-6 h-6 flex justify-center items-center hover:scale-110 transition-transform">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 justify-items-center">
                @forelse($products as $product)
                    <div
                        class="flex flex-col w-full max-w-[380px] bg-white rounded-[35px] shadow-[0_4px_10px_rgba(0,0,0,0.1)] 
                ...
                @empty
                    <div class="col-span-full text-center py-20">
                        ...
                        <a href="{{ route('products.all') }}"
                            class="mt-4 inline-block text-orange-500 font-bold hover:underline">Lihat Semua Produk</a>
                    </div>
                @endforelse
